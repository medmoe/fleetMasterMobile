import {MaintenanceReportWithStringsType, ReportSummaryType} from "@/types/maintenance";
...
export const getMaintenanceStatData = (maintenanceReports: {
...
}): [string, string, string, string, ImageSourcePropType][] => {
    /**
     ...
     *  - An icon (ImageSourcePropType) indicating the trend direction (up or down).
     */
